...
const mockRequests: CreatorRequest[] = [
  {
    ...
    platform: 'instagram',
    verified: true,
    bio: 'Lifestyle & wellness content creator. Passionnée par le bien-être et la mode éthique.',
    motivation: 'Je souhaite accéder aux ressources de cette campagne pour créer du contenu authentique qui correspond à ma communauté.',
    socials: [
  ...
  },
  {
    ...
    platform: 'youtube',
    verified: false,
    bio: 'Tech reviewer & gadget enthusiast. Je teste et partage les dernières innovations tech.',
    motivation: 'Cette campagne correspond parfaitement à mon audience tech. J\'aimerais avoir accès aux fichiers pour produire un contenu de qualité.',
    socials: [
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-12 relative z-10 pb-8">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm text-white/40 font-medium">Createurs en attente d'acces aux ressources</span>
          </div>
        </div>
