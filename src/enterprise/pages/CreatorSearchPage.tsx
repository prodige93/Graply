...
const mockCreators: Creator[] = [
  {
    ...
    verified: true,
    bio: 'Content creator specialise en lifestyle & tech. Contenu authentique pour la Gen Z.',
    platforms: [
  ...
  },
  {
    ...
    verified: true,
    bio: 'Tech reviewer & unboxer. Tests honnetes des derniers gadgets.',
    platforms: [
  ...
  },
  {
    ...
    verified: true,
    bio: 'Coach fitness certifiée. Contenu santé, nutrition et entraînement.',
    platforms: [
  ...
  },
  {
    ...
    verified: true,
    bio: 'Critique culinaire et createur food. Restaurants, recettes et street food.',
    platforms: [
    ...
    <div className="text-white" style={{ backgroundColor: '#050404' }}>
      <div className="max-w-5xl mx-auto">
        <div className="px-4 sm:px-6 lg:px-8 pt-8 pb-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <h1 className="text-xl lg:text-2xl font-bold tracking-tight">Rechercher des createurs</h1>
          <p className="text-sm text-white/40 mt-0.5">Trouvez les createurs parfaits pour vos campagnes</p>
        </div>
        ...
        {showFilters && (
          ...
          >
            ...
            <div>
              <p className="text-[11px] text-white/30 uppercase tracking-wider font-semibold mb-2.5">Catégories</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {creator.verified && <img src={bcreateur} alt="" className="w-[23px] h-[23px]" />}
                    </div>
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-sm font-bold">{renderAmount(formatViews(getTotalViews(creator.platforms)))}</p>
