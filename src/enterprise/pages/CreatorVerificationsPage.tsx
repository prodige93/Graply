...
const platformIconsPreview: Record<string, string> = {
  instagram: instaLogoPreview,
  tiktok: ttLogoPreview,
  youtube: symbolLogoPreview,
};
...
const mockCreators: CreatorApplication[] = [
  {
    ...
    platform: 'instagram',
    verified: true,
    bio: 'Content creator specialise en lifestyle & tech. Je cree du contenu authentique pour les marques qui veulent toucher la Gen Z.',
    videoUrls: [
  ...
  },
  {
    ...
    platform: 'tiktok',
    verified: false,
    bio: 'Passionnee de mode et beaute. 3 ans d\'experience en UGC avec des marques comme Sephora et Zara.',
    videoUrls: [
  ...
  },
  {
    ...
    platform: 'youtube',
    verified: true,
    bio: 'Tech reviewer & unboxer. Je teste les derniers gadgets et je partage mon avis honnete avec ma communaute.',
    videoUrls: [
...
export default function CreatorVerificationsPage() {
  ...
  const backTo = locationState?.from ?? '/validation-videos';
  ...
  return (
    <div className="text-white" style={{ backgroundColor: '#050404' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 -mt-8 lg:-mt-12 relative z-10 pb-8">
  ...
  return (
    <div>
      <button
        ...
        className={`w-full rounded-2xl p-4 lg:p-5 transition-all duration-200 text-left ${
        ...
        <div className="flex items-center gap-3 lg:gap-4">
          ...
          >
            <img
              ...
              className="w-12 h-12 lg:w-14 lg:h-14 rounded-xl object-cover hover:opacity-80 transition-opacity"
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {creator.verified && (
                <img src={bcreateur} alt="Verified" className="w-[23px] h-[23px] shrink-0" />
              )}
            </div>
            <div className="flex items-center gap-1.5 mt-0.5">
              <img src={platformIcons[creator.platform]} alt={creator.platform} className="w-3.5 h-3.5 social-icon shrink-0" />
...
function CreatorProfilePreview({ creator, onViewProfile }: { creator: CreatorApplication; onViewProfile: (c: CreatorApplication) => void }) {
  return (
    <div
    ...
    >
      ...
      <div className="px-5 -mt-10">
        <img
          src={creator.avatar}
          alt={creator.username}
          className="w-20 h-20 rounded-2xl object-cover ring-4 ring-[#1D1C1C] cursor-pointer hover:opacity-80 transition-opacity"
            ...
            {creator.socials.map((social) => (
              ...
              >
                <div className="w-8 h-8 flex items-center justify-center shrink-0">
                  <img
                    src={platformIconsPreview[social.platform]}
                    alt={social.platform}
