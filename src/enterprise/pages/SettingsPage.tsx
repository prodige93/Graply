...
import CguModal from '@/creator/components/CguModal';
  ...
  return (
    <main className="text-white" style={{ background: '#050404' }}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-white font-medium mb-8">Paramètres confidentiel</p>
                ...
                {editingPassword && (
                  <div className="mt-4 ml-12 space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <button onClick={savePassword} className="flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 hover:brightness-110 active:scale-[0.96]" style={{ background: '#fff' }}>
                        <Check className="w-4 h-4 text-black" />
                      </button>
